...
!(function () {
	...
	const I = (e, t) => e.isBlock(t) || E(e.schema.getVoidElements(), t.nodeName),
		...
		R = (e, t) => !e.isBlock(t) && E(e.schema.getWhitespaceElements(), t.nodeName),
		D = (e, t) =>
			((e, t) => {
		...
		W = (e, t, n, r, o) => {
			...
			P(e, i, n, {
				...
				cef: d,
				text: (e) => {
					o ? (t.fOffset += e.length) : (t.sOffset += e.length), t.elements.push(T(e));
				}
			});
		},
		$ = (e, t, n, r, o, s = !0) => {
			...
			W(e, i, n, t, !1);
			const c = () => (
				i.elements.length > 0 && (l.push(i), (i = { sOffset: 0, fOffset: 0, elements: [] })), !1
			);
			return (
				P(
					e,
				...
				r
					? ((e, t, n, r) => {
							const o = n.getBookmark(),
								...
								a = s.length > 0 ? ((e, t) => v(t, (t) => z(e, t)))(e, s) : j(e, n.getRng()),
								l = U(t, a);
		...
		J = (e, t, n) => {
			...
			const a = H(e, o);
			return a.length
				? (s.addClass(H(e, o), 'mce-match-marker-selected'), e.selection.scrollIntoView(a[0]), o)
				: -1;
		},
		L = (e, t) => {
		...
		ee = (e, t, n, r, o) => {
			...
			for (let t = 0; t < d.length; t++) {
				...
				if (o || u === s.index) {
					for (n.length ? ((d[t].innerText = n), K(d[t])) : L(e.dom, d[t]); d[++t]; ) {
	...
	t.add('searchreplace', (t) => {
		const n = e({ index: -1, count: 0, text: '', matchCase: !1, wholeWord: !1, inSelection: !1 });
		return (
			((e, t) => {
