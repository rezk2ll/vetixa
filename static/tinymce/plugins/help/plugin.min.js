...
!(function () {
			...
			const t = (e) =>
				...
				n = (e, n) => {
					...
					((e, t, n) => {
						...
						(e) => {
							...
							return {
								name: n,
								html: t({ name: n, url: `https://www.tiny.cloud/docs/tinymce/7/${e.slug}/` })
							};
						}
					);
					var a, r;
				...
				a = (e) => {
					const t = ((e) => {
						...
						l = r.join('');
					return (
						'<p><b>' + f.translate(['Plugins installed ({0}):', i]) + '</b></p><ul>' + l + '</ul>'
					);
				},
				r = {
					type: 'htmlpanel',
	...
	e.add('help', (e, t) => {
		...
		return (
			((e, t) => {
				e.ui.registry.addButton('help', { icon: 'help', tooltip: 'Help', onAction: t }),
