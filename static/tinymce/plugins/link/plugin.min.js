...
!(function () {
	...
	const G = (e) => s(e) && 'a' === e.nodeName.toLowerCase(),
		...
		Y = (e, t) => (
			...
			le(t) ? m.from(e.dom.select('a[href]', t)[0]) : m.from(e.dom.getParent(t, 'a[href]'))
		),
		Z = (e, t) => Y(e, t).isSome(),
		ee = (e, t) =>
			t
		...
		re = (e) => {
			...
			return (
				!!n.collapsed ||
				0 === J(n, (e) => 1 === e.nodeType && !G(e) && !V(t, e.nodeName.toLowerCase())).length
			);
		},
		le = (e) => s(e) && 'FIGURE' === e.nodeName && /\bimage\b/i.test(e.className),
		ie = (e, t, n) => {
			const o = e.selection.getNode(),
				...
				l = ((e, t) => {
					...
					return (
						...
						(n.href = ((e, t) => (('http' !== t && 'https' !== t) || W(e) ? e : t + '://' + e))(
							n.href,
							_(e)
						)),
						n
		...
		se = (e, t, n) => {
			...
			e.hasPlugin('rtc', !0) ? e.execCommand('createlink', !1, ae(o)) : ie(e, t, o);
		},
		ce = (e) => {
			e.hasPlugin('rtc', !0)
	...
	const fe = (e) => {
		...
		_e = (e) => {
			const t = A(e);
			return l(t) ? I(t).orThunk(() => m.some(be)) : !1 === t ? m.none() : m.some(be);
		},
		we = (e, t, n) => {
		...
		Ce = (e, t) =>
			((e) => {
				...
				return new Promise((e) => {
					...
					e.bind(K(t)).map((e) => (e.length > 0 ? [{ text: 'None', value: '' }].concat(e) : e))
				);
			})(e).then((n) => {
				const o = ((e, t) => {
					const n = e.dom,
				...
				e.on('click', (t) => {
					...
					e.on('keydown', (t) => {
						if (
							...
							13 === t.keyCode &&
							((e) => !0 === e.altKey && !1 === e.shiftKey && !1 === e.ctrlKey && !1 === e.metaKey)(
								t
							)
						) {
							const n = Se(e);
