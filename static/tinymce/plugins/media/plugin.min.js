...
!(function () {
	...
	const S = O.DOM,
		...
		T = (e, t) => {
			let r = {};
			for (let o = A({ validate: !1, forced_root_block: !1 }, t).parse(e); o; o = o.walk())
				if (1 === o.type) {
					const e = o.name;
	...
	const M = (e, t = {}) =>
			A({ forced_root_block: !1, validate: !1, allow_conditional_comments: !0, ...t }, e),
		N = O.DOM,
		...
		G = (e, t) => {
			...
			if (
				!o.source &&
				(j.extend(o, T(null !== (r = o.embed) && void 0 !== r ? r : '', e.schema)), !o.source)
			)
				return '';
		...
		W = (e) => e.hasAttribute('data-mce-object') || e.hasAttribute('data-ephox-embed-iri'),
		q = {},
		H = (e) => (t) => G(e, t),
		J = (e, t) => {
			const r = y(e);
			return r
				? ((e, t, r) =>
						new Promise((o, a) => {
							const s = (r) => (
								r.html && (q[e.source] = r), o({ url: e.source, html: r.html ? r.html : t(e) })
							);
							q[e.source] ? s(q[e.source]) : r({ url: e.source }).then(s).catch(a);
						}))(t, H(e), r)
		...
		Q = (e, t) => {
			const r =
				...
				a = ((e, t, r) => (a) => {
					const s = () => d(e, a),
						n = () => d(t, a),
						l = (e) => d(e, 'value').bind((e) => (e.length > 0 ? i.some(e) : i.none()));
					return {
						[a]: (a === r
							? s().bind((e) => (o(e) ? l(e).orThunk(n) : n().orThunk(() => i.from(e))))
							: n().orThunk(() => s().bind((e) => (o(e) ? l(e) : i.from(e))))
						).getOr('')
					};
				})(e, r, t);
			return { ...a('source'), ...a('altsource'), ...a('poster'), ...a('embed'), ...K(e, r) };
		},
		V = (e) => {
			const t = {
				...e,
		...
		te = (e, t) =>
			((e, t) => e.width !== t.width || e.height !== t.height)(e, t) && ee(t.source, e.type),
		re = (e) => {
			const t = ((e) => {
					...
					onSubmit: (t) => {
						...
						((e, t, r) => {
							...
							(t.embed =
								te(e, t) && k(r)
									? G(r, { ...t, embed: '' })
									: P(null !== (o = t.embed) && void 0 !== o ? o : '', t, !1, r.schema)),
						...
						switch (o.name) {
							case 'source':
								((t, r) => {
									...
									t.source !== o.source &&
										(Y(u, e)({ url: o.source, html: '' }), J(e, o).then(Y(u, e)).catch(X(e)));
								})(r.get(), t);
								break;
							case 'embed':
								((t) => {
									var r;
									const o = Q(t.getData()),
										a = T(null !== (r = o.embed) && void 0 !== r ? r : '', e.schema);
									t.setData(V(a));
								})(t);
								break;
							case 'dimensions':
	...
	const ae = (e) => {
		...
		ue = (e) => {
			let t = e;
			for (; (t = t.parent); ) if (t.attr('data-ephox-embed-iri') || me(t)) return !0;
			return !1;
		},
		de = (e, t, r) => {
					...
					l('webkitallowfullscreen mozallowfullscreen'.split(' '), (e) => {
						...
						r.addAttributeFilter('data-mce-object', (t, r) => {
							...
							for (; a--; ) {
								...
								for (; m--; ) {
									const e = c[m].name;
									0 === e.indexOf('data-mce-p-') && n.attr(e.substr(11), c[m].value);
								}
					...
					e.on('ObjectResized', (t) => {
						...
						if (r.getAttribute('data-mce-object')) {
							...
							o &&
								...
								r.setAttribute(
									'data-mce-html',
									escape(P(o, { width: String(t.width), height: String(t.height) }, !1, e.schema))
								));
						}
					});
			})(e),
