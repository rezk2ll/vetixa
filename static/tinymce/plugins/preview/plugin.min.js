	...
	e.add('preview', (e) => {
		((e) => {
					...
					const n = ((e) => {
						...
						const y = r(e),
							...
							v =
								...
								(t.os.isMacOS() || t.os.isiOS() ? 'e.metaKey' : 'e.ctrlKey && !e.altKey') +
			...
			((e) => {
				...
				e.ui.registry.addButton('preview', { icon: 'preview', tooltip: 'Preview', onAction: t }),
					e.ui.registry.addMenuItem('preview', { icon: 'preview', text: 'Preview', onAction: t });
			})(e);
	});
})();
