...
!(function () {
	...
	const m = (t) => (e) => ((t) => t.dom.nodeType)(e) === t,
		...
		N = (t) => {
			...
			return ((t) => {
				...
				var o;
			})(d(e)).fold(() => o.body.contains(e), ((r = N), (i = b), (t) => r(i(t))));
			var r, i;
		},
		S = (t) =>
			'rtl' ===
	...
	const T = (t, e, n) => {
		...
		C = (t, e) => {
			t.selection.isEditable() && (T(t.dom, t.selection.getSelectedBlocks(), e), t.nodeChanged());
		},
		D = (t, e) => (o) => {
			const r = (r) => {
				const n = d(r.element);
			...
			return (
				t.on('NodeChange', r), o.setEnabled(t.selection.isEditable()), () => t.off('NodeChange', r)
			);
		};
