...
!(function () {
	...
	const u = (t, e) => {
		...
		x = (t) => '<span data-mce-bogus="1" class="mce-' + O[t] + '">' + t + '</span>',
		M = (t) => 'span' === t.nodeName.toLowerCase() && t.classList.contains('mce-nbsp-wrap'),
		P = (t) => {
			const e = f(t);
		...
		H = (t, e) => {
			...
			u(o, (e) => {
				...
				if (M(r))
					...
					const r = n.encode(null !== (o = f(e)) && void 0 !== o ? o : '').replace(j, x),
						s = n.create('div', {}, r);
					let a;
		...
		$ = (t) => {
			...
			(o = void 0 !== o ? o : e), I(t, o), H(t, o), t.selection.moveToBookmark(n);
		},
		F = (t, e) => {
			((t, e) => {
		...
		K = ('visualchars_default_state', (t) => t.options.get('visualchars_default_state'));
	const R = (t, e) => {
			const n = ((t, e) => {
				let n = null;
				return {
