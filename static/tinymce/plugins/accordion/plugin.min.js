	...
	const $ = (e) => void 0 !== e.style && i(e.style.getPropertyValue),
		...
		z = (e) => {
			...
			return ((e) => {
				...
				var o;
			})(P.fromDom(t)).fold(() => o.body.contains(t), ((n = z), (r = H), (e) => n(r(e))));
			var n, r;
		},
	...
	const oe = (e, t) => ({ element: e, offset: t }),
		...
		ie = {
			up: l({
				...
				closest: (e, t, o) =>
					((e, t, o, n, r) =>
						((e, t) => O(e, t))(o, n) ? u.some(o) : i(r) && r(o) ? u.none() : t(o, n, r))(
						0,
						X,
						e,
						t,
			...
			styles: l({
				...
				remove: (e, t) => {
					((e, t) => {
						...
						((e, t, o = c) => e.exists((e) => o(e, t)))(E(e, 'style').map(R), '') && D(e, 'style');
				}
			}),
			attrs: l({
				get: x,
			...
			create: l({ nu: P.fromTag, clone: (e) => P.fromDom(e.dom.cloneNode(!1)), text: P.fromText }),
			query: l({
			...
			e.addCommand('InsertAccordion', () =>
				((e) => {
					...
					e.undoManager.transact(() => {
						e.insertContent(
							[`<details data-mce-id="${n}" class="${le}" open="open">`, a, i, '</details>'].join(
								''
							)
						),
					...
					o.addNodeFilter(de, (e) => {
						for (let t = 0; t < e.length; t++) {
							...
							if (Me(o)) {
								...
								s(d.firstChild) && Oe(d),
									Ee(d, [ce]),
									i || (a(e.firstChild) ? e.insert(d, e.firstChild, !0) : e.append(d));
								const l = a(n),
									c = l ? n : new Se(ue, 1);
