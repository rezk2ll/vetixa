...
<header
	class="z-20 text-slate-700 dark:text-gray-200 bg-white dark:bg-gray-800 w-full fixed flex flex-col overflow-hidden px-4 py-2 lg:flex-row shadow-lg dark:shadow-gray-900/50"
>
	...
	>
			...
			<li class="lg:mr-12">
				<button type="button" class="relative flex items-center" on:click={openSearch}>
					...
					<input
						...
						class="block py-4 pl-14 pr-16 text-blue-950 dark:text-gray-200 bg-transparent placeholder-gray-400/70 dark:placeholder-gray-500 focus:outline-none"
					/>
		...
		<div class="flex items-center lg:ml-auto lg:mr-4">
			<ThemeSwitcher />
		</div>
