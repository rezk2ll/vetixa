<script lang="ts">
	import { addVisitFileFormStore, currentVisit } from '$store/visit';
	import { superForm } from 'sveltekit-superforms/client';

	let uploadFileForm: HTMLFormElement;

	const { form: addFileForm, enhance } = superForm($addVisitFileFormStore, {
		id: 'add-file',
		taintedMessage: null,
		resetForm: true
	});
...
<section class="container px-4 mx-auto">
	...
	<div class="flex items-center justify-between mt-6">
		...
		<div class="items-center hidden md:flex gap-x-3">
			<a href="#" class="px-2 py-1 text-sm text-blue-500 rounded-md dark:bg-gray-800 bg-blue-100/60"
				>1</a
			>
			<a
				href="#"
