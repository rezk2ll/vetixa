...
<div class="relative bottom-0 flex p-3 bg-white dark:bg-gray-900">
	...
	<div class="mx-4">
		<h1 class="text-sm text-gray-700 dark:text-gray-200">Total</h1>
		<p class="text-sm text-gray-500 dark:text-gray-400">{total} dt</p>
	</div>
</div>
