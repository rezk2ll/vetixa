<div class="flex flex-col lg:flex-row w-full items-center justify-center">
	...
	<div
		class="w-full flex h-6 lg:h-12 items-center justify-center bg-emerald-500/80 font-semibold text-gray-700"
	>
		Nouvelle admission
	</div>
	...
	<div
		class="w-full flex h-6 lg:h-12 items-center justify-center bg-orange-500/80 text-white font-semibold"
	>
		À faire
	</div>
	<div
		class="w-full flex h-6 lg:h-12 items-center justify-center bg-yellow-500 font-semibold text-slate-800"
	>
		Passation importante
	</div>
</div>
