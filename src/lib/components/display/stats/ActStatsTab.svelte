...
<div class="flex flex-col items-center justify-start w-full">
	<div
		class="min-w-20 w-full flex items-center justify-center cursor-pointer px-5 py-5 text-xs font-semibold text-white uppercase transition-colors duration-300 transform bg-gray-800 dark:bg-gray-900 focus:outline-none"
	>
		Total général
	</div>
	<div class="w-full p-2 lg:px-0 lg:pt-5 bg-white shadow lg:shadow-2xl border-gray-200">
		<div class="flex flex-col px-2 gap-1">
			<div class="flex items-center justify-between px-3 py-2 bg-gray-200 dark:bg-gray-700 rounded">
				<button
					type="button"
					disabled
				...
				>
				<span
					class="font-bold text-gray-800 dark:text-gray-200 p-1 rounded bg-slate-200 dark:bg-slate-700"
					>{medicalActsTotal} DT</span
				>
			</div>
			<div class="flex items-center justify-between px-3 py-2 bg-gray-200 dark:bg-gray-700 rounded">
				<button
			...
			<div
				class="flex items-center justify-between px-3 py-2 bg-gray-200 dark:bg-gray-700 rounded pl-8"
			>
				<button
					type="button"
					disabled
