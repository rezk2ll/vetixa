	...
	<PrintPdf bind:print>
		<Page>
			<div class="sm:w-11/12 lg:w-full">
					...
					<div class="mt-8 grid sm:grid-cols-2 gap-3">
						<div>
							<div class="flex flex-row space-x-1">
								<h3 class="text-md font-semibold text-gray-800">Raison social:</h3>
				...
				<div class="w-full flex flex-col justify-center items-center fixed bottom-0 space-y-1 text-blue-800">
