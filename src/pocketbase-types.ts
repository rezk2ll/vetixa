...
export type DoctorsResponse<Texpand = unknown> = Required<DoctorsRecord> & BaseSystemFields<Texpand>
...
export type ToilettageResponse<Texpand = unknown> = Required<ToilettageRecord> & BaseSystemFields<Texpand>
...
export type VisitsControlListResponse<Texpand = unknown> = Required<VisitsControlListRecord> & BaseSystemFields<Texpand>
export type VisitsControlViewResponse<Texpand = unknown> = Required<VisitsControlViewRecord> & BaseSystemFields<Texpand>
