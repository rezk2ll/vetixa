...
export type AnimalsCatsListResponse<Texpand = unknown> = Required<AnimalsCatsListRecord> &
	BaseSystemFields<Texpand>;
export type AnimalsDogsListResponse<Texpand = unknown> = Required<AnimalsDogsListRecord> &
	BaseSystemFields<Texpand>;
export type AnimalsFemaleListResponse<Texpand = unknown> = Required<AnimalsFemaleListRecord> &
	BaseSystemFields<Texpand>;
export type AnimalsMaleListResponse<Texpand = unknown> = Required<AnimalsMaleListRecord> &
	BaseSystemFields<Texpand>;
export type AvailableCagesResponse<Texpand = unknown> = Required<AvailableCagesRecord> &
	BaseSystemFields<Texpand>;
...
> &
	BaseSystemFields<Texpand>;
export type HospitPendingListResponse<Ttreatment = unknown, Texpand = unknown> = Required<
	HospitPendingListRecord<Ttreatment>
> &
	BaseSystemFields<Texpand>;
export type HospitalisationResponse<Ttreatment = unknown, Texpand = unknown> = Required<
	HospitalisationRecord<Ttreatment>
> &
	BaseSystemFields<Texpand>;
...
export type VisitsPaidViewResponse<Texpand = unknown> = Required<VisitsPaidViewRecord> &
	BaseSystemFields<Texpand>;
export type VisitsPartialListResponse<Texpand = unknown> = Required<VisitsPartialListRecord> &
	BaseSystemFields<Texpand>;
export type VisitsPartialViewResponse<Texpand = unknown> = Required<VisitsPartialViewRecord> &
	BaseSystemFields<Texpand>;
export type VisitsPendingListResponse<Texpand = unknown> = Required<VisitsPendingListRecord> &
	BaseSystemFields<Texpand>;
export type VisitsPendingViewResponse<Texpand = unknown> = Required<VisitsPendingViewRecord> &
	BaseSystemFields<Texpand>;
